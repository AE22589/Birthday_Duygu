...
if (!script.includes(`const VERSION='1.6.2'`)) throw new Error('app version mismatch');
if (!road.includes(`const VERSION='1.6.2'`)) throw new Error('roadtrip version mismatch');

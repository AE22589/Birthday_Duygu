...
if(!index.includes('style.css?v=1.3.1')||!index.includes('script.js?v=1.3.1')||!index.includes('roadtrip.js?v=1.3.1'))throw new Error('cache version mismatch');
if(!script.includes("const VERSION='1.3.1'"))throw new Error('app version mismatch');
if(!road.includes("const VERSION='1.3.1'"))throw new Error('roadtrip version mismatch');
...
console.log('PASS: v1.3.1 static QA');
console.log({requiredAssets:required.length,cache:'v1.3.1',renderer:'HTML/CSS layered art',viewState:'intro -> game -> result',hiddenGuard:true,security:'preserved',controls:['ArrowLeft','ArrowRight','A','D','swipe']});

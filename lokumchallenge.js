...
const MAZE_1=Object.freeze({
  ...
  walls:Object.freeze([
    [9,3,13,5,1,5,3,9,3],
    [10,8,7,9,0,3,8,4,2],
    [12,2,13,4,2,12,2,11,10],
    [9,4,3,9,4,7,12,6,10],
    [10,11,10,8,1,1,3,11,10],
    [10,12,4,0,2,10,12,4,2],
    [8,7,11,8,4,4,3,11,10],
    [10,9,4,6,9,7,8,6,10],
    [12,6,13,5,6,13,6,13,6]
  ]),
  ...
  treats:Object.freeze([
    [0,2],[1,5],[2,7],[3,4],[4,7],[5,5],[6,2],[7,6]
  ])
});
...
const MAZE_2=Object.freeze({
  ...
  walls:Object.freeze([
    [9,7,11,13,7,9,7,13,7,11,11],
    [14,9,4,3,9,6,9,7,11,14,10],
    [9,6,11,12,6,9,6,9,4,5,2],
    [10,9,4,3,15,14,9,4,1,3,14],
    [10,10,13,4,1,1,6,9,6,8,3],
    [10,12,3,11,14,12,1,6,9,6,10],
    [8,5,4,2,11,11,12,1,6,9,2],
    [10,9,7,10,10,12,3,12,1,6,10],
    [10,10,9,2,12,3,12,7,10,9,6],
    [8,2,10,12,3,12,1,1,2,14,11],
    [14,14,12,7,12,5,6,12,4,5,6]
  ]),
  ...
  treats:Object.freeze([
    [2,1],[3,10],[4,2],[5,4],[5,8],[6,0],[7,2],[7,9],[9,4],[9,9],[6,5],[8,7]
  ])
});
